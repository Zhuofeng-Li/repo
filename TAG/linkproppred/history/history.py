...
class History(InMemoryDataset):
    ...
    def raw_dir(self) -> str:
        return osp.join(self.root, 'history_dataset', 'raw')

    @property
    def processed_dir(self) -> str:
        return osp.join(self.root, 'history_dataset', 'processed')
    ...
    def process(self) -> None:
        path = osp.join(self.raw_dir, 'goodreads_reviews_history_biography.json')
