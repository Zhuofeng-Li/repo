...
from TAG.linkproppred.history.history import History
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_type', '-dt', type=str, default='children',
                        help='data type for datasets, options are children, mystery_thriller_crime, comics_graphic, history')
    ...
    if args.data_type == 'children':
        ...
        Dataset = History(root=f'{args.data_type}')
    else:
